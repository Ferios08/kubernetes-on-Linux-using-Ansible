...
echo -n "To install a specific version of Kubernetes, set it up manually in the env_variables file"
...
echo -n "Please Note that this Script back your current setup up if launched again, and it will overwrite any backed up configuration"
echo -n "you can check the  env_variables and hosts file to verify your actual configuration"